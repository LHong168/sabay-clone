        ...
        <footer className='bg-black py-5'>
            <div className='m-auto flex w-full flex-wrap justify-between text-center text-white md:w-5/6 md:text-start xl:w-3/5'>
                <div className='mb-5 w-full md:w-[25%]'>
                    ...
                    <p className='text-md mt-2 text-gray-400'>​© រក្សា​សិទ្ធិ​គ្រប់​យ៉ាង​ដោយ​ Sabay ឆ្នាំ​២០២៤</p>
                    <p className='text-md mt-2 font-bold text-gray-300'>គោលការណ៍​ភាព​ឯកជន | Privacy Policy</p>
                ...
                <div className='mb-5 w-full md:w-[25%]'>
                    ...
                    <p className='text-md mt-5 text-gray-300'>Sabay Digital Corporation ជា​ក្រុមហ៊ុន​ព័ត៌មាន​ឌីជីថល និង​កម្សាន្ត​ឈាន​មុខ​គេ​នៅ​កម្ពុជា។ ព័ត៌មាន​បន្ថែម</p>

                    <div className='mt-3'>
                        <p className='text-md font-medium text-gray-300'>ផលិត​ផល​ និង​ សេវាកម្ម របស់ Sabay</p>
