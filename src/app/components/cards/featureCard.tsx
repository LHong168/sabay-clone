...
const FeatureCard = () => {
  return (
    <div className="relative w-full bg-black overflow-hidden shadow-lg group">
        <img src="maxresdefault.jpg" alt="" className="object-cover w-full h-full opacity-80" />
        ...
        <div className="absolute bottom-0 left-0 right-0 p-1 px-3 py-2 -translate-y--10 group-hover:-translate-y-10 z-10 transition duration-300">
            <h2 className="text-md font-semibold text-white group-hover:text-red-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, expedita quasi neque</h2>
            <p className="text-sm text-gray-300 overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima consectetur</p>
        </div>
    </div>
  )
}
